...
namespace TheFirstPerson
{
    ...
    public class FPSController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            jointOriginalPos = cam.localPosition;

            joint.localEulerAngles = new Vector3(0, 0, 360f);
            ...
            cameraOffset = standingHeight - cam.transform.parent.localPosition.y;
            ...
            if (dt > 0)
            {
                ...
                if (crouchEnabled && crouching)
                {
                    if (controller.height > crouchColliderHeight)
                    {
                        ...
                        GameObject.FindWithTag("Player").GetComponent<CapsuleCollider>().height = Mathf.MoveTowards(controller.height, crouchColliderHeight, dt * crouchTransitionSpeed);
                    }
                }
                else
                {
                    if (controller.height < standingHeight)
                    {
                        ...
                        else
                        {
                            ...
                            GameObject.FindWithTag("Player").GetComponent<CapsuleCollider>().height = Mathf.MoveTowards(controller.height, standingHeight, dt * crouchTransitionSpeed);
                        }
                    }
                }
                ...
                GameObject.FindWithTag("Player").GetComponent<CapsuleCollider>().center = new Vector3(0, controller.height / 2.0f, 0);
